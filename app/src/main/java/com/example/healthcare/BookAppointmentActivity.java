...
public class BookAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ed3 = findViewById(R.id.editTextLTBPin);
        ed4 = findViewById(R.id.editTextLTBPhone);
        ...
        ed2.setText(address);
        ed3.setText(contact);
        ed4.setText("Tarif consult: " + fees + " lei");
        ...
        btnBook.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(db.checkAppExists(username, title + " => " + fullName, address, contact, dateButton.getText().toString(), timeButton.getText().toString()) == 1) {
                    Toast.makeText(getApplicationContext(), "Rezervarea deja a fost făcută!", Toast.LENGTH_LONG).show();
                } else {
